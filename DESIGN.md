...
**Brand assets — `public/brand/` ships seven files:** `logo-disc.png`, `showbill-lettering.png`, `wordmark-black.png`, `wordmark-white.png`, plus the three ambient pieces `ambient-emb-1.png` / `ambient-emb-2.png` (corner embroidery) and `ambient-showbill.png` (centered showbill watermark, ≥ 900px, opacity 0.04 — the quietest layer) — owner-sanctioned (2026-07-20), Search-screen desktop ambience only, `#2E1351` tint baked into the PNGs (CSS carries only opacity + placement, static, ≥ 768px).
