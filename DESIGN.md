...
**Brand assets — `public/brand/` ships six files:** `logo-disc.png`, `showbill-lettering.png`, `wordmark-black.png`, `wordmark-white.png`, plus the two ambient embroidery pieces `ambient-emb-1.png` / `ambient-emb-2.png` — owner-sanctioned (2026-07-20), Search-screen desktop ambience only, `#2E1351` tint baked into the PNGs (CSS carries only opacity + placement, static, ≥ 768px).
