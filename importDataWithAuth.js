...
const serviceAccount = {
  ...
  "project_id": "mafia-recruitments",
  "private_key_id": "your-private-key-id",
  "private_key": "-----BEGIN PRIVATE KEY-----\nYOUR_PRIVATE_KEY_HERE\n-----END PRIVATE KEY-----\n",
  "client_email": "firebase-adminsdk-xxxxx@mafia-recruitments.iam.gserviceaccount.com",
  "client_id": "your-client-id",
  "auth_uri": "https://accounts.google.com/o/oauth2/auth",
  "token_uri": "https://oauth2.googleapis.com/token",
  "auth_provider_x509_cert_url": "https://www.googleapis.com/oauth2/v1/certs",
  "client_x509_cert_url": "https://www.googleapis.com/robot/v1/metadata/x509/firebase-adminsdk-xxxxx%40mafia-recruitments.iam.gserviceaccount.com"
};
...
class SecureDataImporter {
  ...
  validateAndCleanData(row, index) {
    try {
      ...
      const candidateData = {
        ...
        paid: false,
        paymentDetails: null,
        lastUpdatedBy: 'Secure Import Script',
  ...
  async saveCandidate(candidateData, documentId) {
    try {
      const ref = db.collection("candidates").doc(documentId);
      await ref.set(candidateData);
      return true;
    } catch (error) {
